...
class TestFeatureEncoderDecoder(unittest.TestCase):
    ...
    def test_feature_encoder(self):
        ...
        feature2 = CryoFeature("Feature-2", stage_pos={"x": 1e-3, "y": 1e-3, "z": 1e-3}, focus_pos={"z": 2e-3})
    ...
    def test_feature_decoder(self):
        ...
        self.assertEqual(features[1].stage_pos.value, {"x": 1e-3, "y": 1e-3, "z": 1e-3})
        self.assertEqual(features[1].focus_pos.value, {"z": 2e-3})
