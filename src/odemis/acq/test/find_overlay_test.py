...
class TestFindOverlay(unittest.TestCase):
    """
    Test FindOverlay functions
    """
    def test_do_find_overlay(self):
        ...
        (calc_translation_x, calc_translation_y), calc_scaling, calc_rotation = find_overlay.DoFindOverlay((9, 9), 1e-06, 1e-07, escan, ccd, detector)
    ...
    def test_do_find_overlay_failure(self):
        ...
        self.assertRaises(KeyError, find_overlay.DoFindOverlay, (9, 9), 1e-06, 1e-08, escan, ccd, detector)


if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(TestFindOverlay)
