...
class MeteorTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.posture_manager.switch_posture(Posture.LOADING).result()
        cls.posture_manager.switch_posture(Posture.SEM_IMAGING).result()
        cls.posture_manager.switch_posture(Posture.FM_IMAGING).result()
