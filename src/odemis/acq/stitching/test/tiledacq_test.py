...
class CRYOSECOMTestCase(unittest.TestCase):
    ...
    def test_get_number_of_tiles(self):
        ...
        num_tiles, _, tile_indices = tiled_acq_task._getNumberOfTiles()
        self.assertEqual(num_tiles, 1)
        self.assertEqual(tile_indices, [(0, 0)])
        ...
        self.assertEqual(tile_indices, [(0, 0), (1, 0), (0, 1), (1, 1)])
        ...
        self.assertEqual(tile_indices, [(0, 0), (0, 1)])
        ...
        self.assertEqual(tile_indices, [(col, row) for row in range(7) for col in range(4)])
