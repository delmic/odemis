...
Z_LOW = 0.028  # m, safe value provided by TFS on a Hydra Bio system
DELTA_Z = 0.001  # m, change in z used for increasing or decreasing Z_LOW
        ...
        try:
            ...
            if target in (GRID_1, GRID_2):
                ...
                if (type(self) == MeteorTFS1PostureManager):
                    ...
                    # Calculate safe z value while moving to FM position. It should be lower than z_low and
                    # if z_low is 0, then there is no change
                    if z_low != 0:
                        z_low_fm = z_low - DELTA_Z  # safe z to achieve before switching to FM posture
                    else:
                        z_low_fm = z_low
                    ...
                    if (current_label in [SEM_IMAGING, MILLING, FIB_IMAGING]
                      and target == FM_IMAGING
                        ...
                        sub_moves.append((self.stage, {"z": z_low_fm}))
                        sub_moves.append((self.stage, filter_dict({'rx', 'rz'}, target_pos)))
                        ...
                        # Stage switching based on Hydra Bio xt assessment
