...
class MeteorPostureManager(MicroscopePostureManager):
    ...
    def _update_conversion(self,
        ...
        # Rotate by 180° to compensate for the stage being rotated in rx compared to the SEM imaging posture
        ...
        # SEM imaging: stage 180° rotated along rz compared to FM IMAGING
        tf_tilt, _ = get_rotation_transforms(rx=-pre_tilt)
