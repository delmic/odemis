...
import sys
sys.path.append("/home/patrick/development/openfibsem/fibsem")
...
from fibsem.milling import FibsemMillingStage, estimate_total_milling_time, mill_stages, MillingAlignment
