...
class RectanglePatternParametersTestCase(unittest.TestCase):
    ...
    def test_json(self):
        # test to_dict
        rectangle_pattern_json = self.pattern.to_dict()
        ...
        # test from_dict
        rectangle_pattern_from_json = RectanglePatternParameters.from_dict(rectangle_pattern_json)
...
class TrenchPatternParametersTestCase(unittest.TestCase):
    ...
    def test_json(self):
        # test to_dict
        trench_pattern_json = self.pattern.to_dict()
        ...
        # test from_dict
        trench_pattern_from_json = TrenchPatternParameters.from_dict(trench_pattern_json)
...
class MicroexpansionPatternParametersTestCase(unittest.TestCase):
    ...
    def test_json(self):
        # test to_dict
        microexpansion_pattern_json = self.pattern.to_dict()
        ...
        # test from_dict
        microexpansion_pattern_from_json = MicroexpansionPatternParameters.from_dict(microexpansion_pattern_json)
