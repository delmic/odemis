...
from odemis.acq.milling.openfibsem import run_milling_tasks_openfibsem, OpenFIBSEMMillingTaskManager
...
class TestOpenFIBSEMMillingManager(unittest.TestCase):
    ...
    Requires the xt simulator to be running
    """
    ...
    def test_estimate_total_milling_time(self):
        ...
        openfibsem_milling_manager = OpenFIBSEMMillingTaskManager(None,
                                                                  self.milling_tasks)
