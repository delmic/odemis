...
from odemis.acq.milling.patterns import pattern_generator, MillingPatternParameters

# milling tasks
FEATURE_ACTIVE, MILLING_READY, MILLING_ROUGH, MILLING_FINE, MILL_POLISHING = "Feature Active", "Milling Ready", "Rough Milling", "Fine Milling", "Polishing" 
...
class MillingTaskSettings:
    ...
    def __init__(self, milling: dict, patterns: list, name: str = "Milling Task"):
        self.name = name
...
def load_milling_tasks(path: str, task_list: List[str]) -> Dict[str, MillingTaskSettings]:
    milling_tasks = {}
