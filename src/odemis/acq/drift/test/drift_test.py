...
class TestAnchoredEstimator(unittest.TestCase):
    ...
    def test_estimateCorrectionPeriod(self):
        ...
        ieo = (# drift period > whole acquisition time
               ((10, 1e-6, (50, 40)), [10 / 1e-6]),
               ((100, 1e-6, (50, 40)), [100 / 1e-6]),
               # drift period <= pixel time
               ((10, 10, (50, 40)), [1] * 40 * 50),
               ((1.3, 1.4, (50, 40)), [1] * 40 * 50),
               # drift period < 2 * pixel time
               ((0.9, 0.6, (50, 40)), [1] * 40 * 50),
               # line time < drift period < pixel time
               ((0.38, 0.01, (50, 38)), [38] * 50),
               ((0.37, 0.01, (50, 38)), [38] * 50),
               ((1, 0.5, (50, 36)), [2] * 18),
               ((0.9, 0.1, (50, 36)), [9, 9, 9, 9] * 50),
               ((0.9, 0.1, (50, 37)), [9, 9, 9, 10] * 50),
               ((0.9, 0.1, (50, 38)), [9, 10, 9, 10] * 50),
               ((0.4, 0.01, (50, 40)), [40] * 50),
               # whole acq < drift period < line time
               ((10.1, 0.5, (50, 20)), [20] * 50),
               ((0.39, 0.01, (50, 38)), [38] * 50),
               ((0.8, 0.01, (50, 40)), [80] * 25),
               ((0.8, 0.001, (50, 40)), [800] * 3),
               )
        for i, eo in ieo:
