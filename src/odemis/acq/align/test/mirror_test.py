    ...
    def test_3d_alignment_success_rate(self):
        ...
        for i in range(n_tests):
            ...
            if intensity >= success_threshold:
                ...
                failed_run_warn.append(f"Low intensity ({intensity:.1f}) for run {i} dl={dl:.1e}, ds={ds:.1e}, dz={dz:.1e}")
    ...
    def test_1d_alignment_success_rate(self):
        ...
        for i in range(n_tests):
            ...
            if intensity >= success_threshold:
                ...
                failed_run_warn.append(f"Low intensity ({intensity:.1f}) for run {i} dz={dz:.1e}")
