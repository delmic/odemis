...
def MatchCoordinates(input_coordinates, electron_coordinates, quessing_scale, max_allowed_diff):
    """
    ...
    quessing_scale (float): Guess scaling for the first transformation
    ...
    quess_scale = quessing_scale
    guess_rotation = 0

    # Informed guess
    guess_coordinates = _TransformCoordinates(optical_coordinates, (guess_x_move, guess_y_move), guess_rotation, quess_scale)
