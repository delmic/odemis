...
def run_tdct_correlation(fib_coords: numpy.ndarray,
    ...
    :param fib_coords: the FIB coordinates (x, y) (in pixels, origin at top left)
    :param fm_coords: the FM coordinates (x, y, z) (in pixels, origin at top left)
    :param poi_coords: the point of interest coordinates (x, y, z)
    :param fib_image: the FIB image (YX)
    :param fm_image: the FM image (CZYX or ZYX)
...
def get_poi_coordinate(correlation_results: dict) -> Tuple[float, float]:
    ...
    The coordinate is centred at the image centre.
