...
class CalibrationTask(object):
    ...
    def run(self):
        ...
        self._future.set_progress(total_time=self._future.elapsed_time + total_calibration_time)  # provide end time to future
        ...
        try:
            ...
            for calib in self.calibrations:
                ...
                self._future.set_progress(total_time=self._future.elapsed_time + self.estimate_calibration_time())
