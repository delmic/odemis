...
def acquireNonRectangularTiledArea(roi, stream, stage, acq_dwell_time, scanner_conf, reference_stage=True, live_stream=None):
    """
    ...
    _executor.submitf(f, overview_acq.run, sem_stream, stage, roi.shape.points.value, live_stream, scanner_conf, reference_stage)
