...
class AcquisitionTask(object):
    ...
    def __init__(self, scanner, multibeam, descanner, detector, stage, scan_stage, ccd, beamshift, lens, se_detector,
        ...
        if isinstance(future, model.ProgressiveFuture):
            self._total_roa_time = future.remaining_time
...
class OverviewAcquisition(object):
    ...
    def run(self, stream, stage, area, live_stream, scanner_conf=None, reference_stage=True, file_pattern=None,
        ...
        def _pass_future_progress(sub_f, elapsed_time, remaining_time):
            self._future.set_progress(remaining_time=remaining_time)
