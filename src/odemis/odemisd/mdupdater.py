...
# https://eev.ee/blog/2011/04/24/gotcha-python-scoping-closures/)
    ...
    def get_filter_pos(self, filter: Optional[model.HwComponent]) -> Union[Iterable[float], str, None]:
        """
    ...
    def convert_filter_to_bandwidth(self, pos: Union[Iterable[float], str, None]) -> Optional[Tuple[float, float]]:
        """
