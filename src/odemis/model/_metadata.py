...
MD_ACQ_RECIPES = "Acquisition recipes"  # str, comma-separated names of the recipe files used to configure the streams for an acquisition
...
MD_LENS_WD = "Lens working distance"  # float (m), working distance
...
MD_FM_POS_SAMPLE_DEACTIVE = "Sample FM position deactive"  #  dict[str, float] representing the last SEM (z) position, projected in FM sample stage coordinates
