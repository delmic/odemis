...
MD_POS_TRANS_COR = "Stage translation correction"  # (m, m) correction to be applied to the meteor stage translation
MD_POS_ROT_COR = "Stage rotation correction"  # rad, correction to be applied to the meteor stage rotation
...
MD_FAV_FIB_POS_ACTIVE = "Favourite FIB positive active"  # dict -> float representing the position required for FIB imaging
