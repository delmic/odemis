...
MD_ERROR = "Error"  # (dict) Dictionary with errors of calibrations, calibration name as key and error as value
# dict of dicts with lifetime, size, positionX and position Y as keys -->
# {aperture1: {lifetime: value, size: value, positionX: value, positionY: value},
#  aperture2: {lifetime: value, size: value, positionX: value, positionY: value}, etc.}
