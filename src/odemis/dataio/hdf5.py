...
def _parse_physical_data(pdgroup, da):
    ...
    for i, d in enumerate(das):
        ...
        # slit width
        read_metadata(pdgroup, i, md, "SlitWidth", model.MD_SLIT_WIDTH, converter=float)
        # extra settings
...
def _add_image_metadata(group, image, mds):
    ...
    binning, st_binning = [], []
    # Slit width: (float) width of the slit used in the spectrometer
    slit_width, st_slit_width = [], []
    ...
    for md in mds:
        ...
        # Slit width
        append_metadata(st_slit_width, slit_width, md, model.MD_SLIT_WIDTH, default_value=0)
    ...
    # Slit width
    set_metadata(gp, "SlitWidth", st_slit_width, slit_width)
