...
class Scanner(model.Emitter):
    ...
    def _generate_scan_array_from_path(self,
        ...
        """
        Convert the scan path to raw values.
        Map linearly values between limits_px[0] and limits_px[1] to values between limits_raw[0] and
        limits_raw[1], and duplicate every pixel according to the dup factor.
        :param scan_path: the scan path to set, as a 2D numpy array of shape (N, 2).
        ...
        First dimension is X/Y, second dimension is min/max.
        :param dup: (1<=int): how many times each pixel should be duplicated
        :return: the scan array, as a numpy array of shape (2, N, dup), where N is the number of points in the scan path.
        """
