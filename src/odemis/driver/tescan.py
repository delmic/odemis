...
class SEM(model.HwComponent):
    ...
    def _single_acquisition(self, detector):
        ...
        with self._acquisition_init_lock:
            ...
            self._device_handler.device.connection.socket_c.setsockopt(socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)
            self._device_handler.device.connection.socket_d.setsockopt(socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)
