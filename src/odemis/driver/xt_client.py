...
STAGE_FRACTION_TOTAL_MOVE = 0.01  # percentage of tolerance of the requested stage movement
    ...
    def _moveTo(self, future: futures.Future, pos: Dict[str, float], rel: bool = False, timeout: float = 60) -> None:
        with future._moving_lock:
            try:
                ...
                # TODO: base the timeout on the stage movement time estimation, needs to be checked on hardware
                # axes_list = [ax for ax in orig_pos.keys()]
                # timeout = estimate_stage_movement_time(
                #     stage=self,
                #     start_pos=orig_pos,
                #     end_pos=target_pos,
                #     axes=axes_list,
                ...
                # )
                # wait_stage_move = timeout * 5 + 3  # s, adding extra margin
