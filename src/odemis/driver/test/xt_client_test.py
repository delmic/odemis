...
class TestScanner(unittest.TestCase):
    ...
    def test_beam_shift_transformtion_matrix_VA(self):
        ...
        self.assertIsInstance(beamShiftTransformtionMatrix.value, list)
        self.assertEqual(len(beamShiftTransformtionMatrix.value), 4)
        for row_transformationmatrix in beamShiftTransformtionMatrix.value:
