...
class TestKeysight(unittest.TestCase):
    ...
    def test_duty_cycle(self):
        ...
        # At 25ns period, 95% is out of range
    ...
    def test_delay(self):
        ...
        # Should be automatically clipped when period is reduced, even when power is turned off
        self.dev.power.value = False
        self.dev.delay.value = 1e-5
