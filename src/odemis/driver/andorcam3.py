...
#             else:
    ...
    def setFanSpeed(self, speed):
        ...
        # In case the speed is not available, find the closest one higher available
        while values[speed_index] is None and speed_index < len(values) - 1:
            speed_index += 1
        # If no higher speed is available (very unlikely), find the closest one lower available
        while values[speed_index] is None and speed_index > 0:
            speed_index -= 1
