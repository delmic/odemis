...
class TestProjectYXC2RGB8(unittest.TestCase):
    ...
    def test_tint(self):
        ...
        out = img.projectYXC2RGB8(src.copy(), irange=(0, 255), tint=(255, 0, 0))
        self.assertEqual(out.shape, shape)
        self.assertEqual(out.dtype, numpy.uint8)
        # black stays black
        numpy.testing.assert_array_equal(out[0, 0], [0, 0, 0])
        ...
        out = img.projectYXC2RGB8(src.copy(), irange=(0, 255), tint=(0, 255, 255))
        self.assertEqual(out.shape, shape)
        self.assertEqual(out.dtype, numpy.uint8)
        # black stays black
        numpy.testing.assert_array_equal(out[0, 0], [0, 0, 0])
    ...
    def test_tint_rgba(self):
        ...
        out = img.projectYXC2RGB8(src.copy(), irange=(0, 255), tint=(0, 255, 0))
        self.assertEqual(out.shape, shape)
        self.assertEqual(out.dtype, numpy.uint8)
