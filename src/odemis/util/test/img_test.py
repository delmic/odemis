...
class TestTintToMdFormat(unittest.TestCase):
    ...
    # test for tuple instance
    # test for colormap instance
    # test for str instance
...
class TestMdFormatToTint(unittest.TestCase):
    ...
    # test for tuple instance
    # test for str instance
    # test for unexpected str instance
    # test for colormap instance
    # test for unexpected type
...
class TestGetOutliers(unittest.TestCase):
    ...
    # output is tuple of 2 floats for min/max range
    # test for default outliers value
    # test for max outliers value
...
class TestGuessDRange(unittest.TestCase):
    # input DA/None
    # output drange (2 valued tuple of int)
    # test for wrong data type,
    # test for BPP < 1,
    # test for int/uint?
    # test for force key error
...
class TestGetCenterOfTiles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        tile4 = model.DataArray(np.zeros(self.size), md)
