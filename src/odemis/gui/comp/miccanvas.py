...
class FastEMAcquisitionCanvas(DblMicroscopeCanvas):
    ...
    def add_calibration_overlay(self, coordinates, label, sample_bbox, roc_size, colour=gui.FG_COLOUR_WARNING):
        """
        ...
        colour (str): border colour of ROA overlay, given as string of hex code
        """
        overlay = world_overlay.FastEMROCOverlay(self, coordinates, label, sample_bbox, roc_size, colour=colour)
        self.add_world_overlay(overlay)
