...
class RepetitionSelectOverlay(WorldOverlay, RectangleEditingMixin):
    ...
    def __init__(self, cnvs, roa=None, scanner=None, rotation=None, colour=gui.SELECTION_COLOUR):
        ...
        :param scanner (None or HwComponent): The scanner component to which the relative
         ROA. If None, the roa argument is interpreted as absolute physical coordinates (m).
         If it's a HwComponent, the roa will be interpreted as a ratio of its field of view.
