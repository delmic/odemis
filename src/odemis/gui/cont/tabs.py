...
class EnzelAlignTab(Tab):
    ...
    def __init__(self, name, button, panel, main_frame, main_data):
        ...
        for vp in viewports[2:]:  # Even though we have 3 viewports defined we want 2 to be shown.
            vp.Shown = False
        ...
        # Create sem stream
        self._sem_stream = acqstream.SEMStream("SEM", main_data.sed,
                                               main_data.sed.data,
                                               main_data.ebeam,
                                               hwdetvas=get_local_vas(main_data.sed, main_data.hw_settings_config),
                                               hwemtvas=get_local_vas(main_data.ebeam, main_data.hw_settings_config),
        ...
        self._step_size_controls_va_connector = VigilantAttributeConnector(tab_data.step_size_controls_va,
    ...
    def _set_current_align_mode(self, clicked_align_mode):
        ...
        self._align_btn_functions[clicked_align_mode]()  # Links the button to the setter of the correct mode
    ...
    def _sem_alignment_controls(self, axis, proportion, evt):
        ...
        # Beam shift control
        shift = {"x": 0, "y": 0}
        shift.update({axis: proportion * self.tab_data_model.step_size_controls_va.value})
        self._sem_move_beam_shift_rel(shift)
        time.sleep(0.5)
    ...
    def _set_top_and_bottom_stream_and_settings(self, top, bottom):
        ...
        :param bottom: The bottom stream and corresponding viewport accessible via the keys 'stream'/'viewport'
        """
