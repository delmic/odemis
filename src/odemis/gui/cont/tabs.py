...
from odemis.acq.move import GRID_1, GRID_2, LOADING, COATING, MILLING, UNKNOWN, ALIGNMENT, LOADING_PATH, \
    IMAGING, FM_IMAGING, SEM_IMAGING, POSITION_NAMES, THREE_BEAMS, SAFETY_MARGIN_5DOF
...
class Sparc2AlignTab(Tab):
    ...
    def _onAlignMode(self, mode):
        ...
        if mode != "specswitch-align":
            ...
            # only enable the specswitch panel in the right mode
        ...
        if mode == "lens-align":
            ...
            if self._mirror_settings_controller:
                self._mirror_settings_controller.enable(False)
            if "specswitch-align" not in self.tab_data_model.align_mode.choices:
