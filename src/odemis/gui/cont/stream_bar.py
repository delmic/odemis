...
from odemis.gui.cont.cryo_project import remove_image, save_project
...
class StreamBarController(object):
    ...
    def _on_roa_rotation(self, angle: float) -> None:
        """
...
class CryoAcquiredStreamsController(CryoStreamsController):
    ...
    @call_in_wx_main
    def _display_feature_streams(self, feature: Optional[CryoFeature]) -> None:
        """
        ...
        :param feature: the feature whose streams to display
        """
