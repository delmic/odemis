        ...
        if "tunnel-lens-align" in tab_data.align_mode.choices:
            ...
            if spec:
                ...
                if any(ext_ccd):
                    ...
                    # Automatically, the slit-in is opened ot the maximum. Still, add a slit-in axis
                    # control to the stream panel, so that it's possible to go to the minimum opening,
                    # in order to do a fine alignment in X.
