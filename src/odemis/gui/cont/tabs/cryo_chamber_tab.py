...
class CryoChamberTab(Tab):
    ...
    def _reset_project_data(self):
        try:
            ...
            localization_tab: LocalizationTab = self.tab_data_model.main.getTabByName(TabName.CRYOSECOM_LOCALIZATION.value)
            ...
            correlation_tab: CorrelationTab = self.tab_data_model.main.getTabByName(TabName.METEOR_CORRELATION.value)
    ...
    def _load_project_data(self, evt: wx.Event) -> bool:
        ...
        fibsem_tab = None
        try:
            fibsem_tab: Tab = self.tab_data_model.main.getTabByName(TabName.METEOR_FIBSEM.value)
    ...
    def _display_meteor_pos_warning_msg(self, end_pos) -> bool:
        ...
        warn_msg = f"The stage will move to this position:\n{pos_str}\n\nIs it safe?"
        box = wx.MessageDialog(self.main_frame,
                               warn_msg,
