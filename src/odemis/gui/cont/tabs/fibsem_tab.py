...
class FibsemTab(Tab):
    ...
    def __init__(self, name, button, panel, main_frame, main_data):
        ...
        self.panel.btn_apply_to_feature.Bind(wx.EVT_BUTTON, self._on_apply_angle_to_feature)
        self.panel.btn_apply_to_features.Bind(wx.EVT_BUTTON, self._on_apply_angle_to_features)
    ...
    def _on_current_feature_va(self, evt: wx.Event):
        if self.main_data.currentFeature.value:
            self.panel.btn_apply_to_feature.Enable()
        else:
            self.panel.btn_apply_to_feature.Disable()
