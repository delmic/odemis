...
class CryoAcquiController(object):
    ...
    def __init__(self, tab_data, panel, tab):
        ...
        if self.acqui_mode is guimod.AcquisitionMode.FLM:
        ...
        self._panel.btn_acquire_features.Show(ODEMIS_ADVANCED_FLAG and self.acqui_mode is guimod.AcquisitionMode.FLM)
        self._panel.chk_use_autofocus_acquire_features.Show(ODEMIS_ADVANCED_FLAG and self.acqui_mode is guimod.AcquisitionMode.FLM)

        # fibsem specific acquisition settings
        if self.acqui_mode is guimod.AcquisitionMode.FIBSEM:
    ...
    def _get_acqui_streams(self, evt: wx.Event) -> List[stream.Stream]:
        ...
        if (self.acqui_mode is guimod.AcquisitionMode.FIBSEM and
