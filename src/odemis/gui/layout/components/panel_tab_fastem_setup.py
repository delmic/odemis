...
class PnlTabFastemSetup(wx.Panel):
    ...
    def _build_acquisition_status_panel(self, parent: wx.Window) -> wx.Panel:
        ...
        with vbox() as sizer:
            ...
            self.btn_acq = self._text_button(
                panel,
                "START",
                height=48,
                face_colour="blue",
    ...
    def _build_calibration_status_panel(self, parent: wx.Window) -> wx.Panel:
        ...
        with vbox() as sizer:
            ...
            self.btn_calib = self._text_button(
                self.pnl_calib_status,
                "RUN",
                height=48,
                face_colour="blue",
    ...
    def _build_progress_row(
        ...
        with hbox() as sizer:
            ...
            cancel_button = self._text_button(parent, "Cancel", height=24)
            cancel_button.Hide()
    ...
    def _text_button(
        ...
        if contrast and face_colour == "def":
            raise ValueError("Contrasting text requires a non-default button face")
