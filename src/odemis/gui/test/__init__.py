...
from odemis.acq.move import FM_IMAGING, MeteorTFS1PostureManager
...
class GuiTestCase(unittest.TestCase):
    ...
    def create_cryo_tab_model(self):
        stage = TMCLController(name="Linked YZ", role="stage-bare",
                               port="/dev/fake6",
                               axes=["x", "y", "z", "rx", "rz"],
        ...
        with patch('odemis.model.getComponent', side_effect=getComponent),\
            ...
            main = gmodel.MainGUIData(microscope)  # no microscope backend
            main.posture_manager = MeteorTFS1PostureManager(microscope)
