...
#!XRCED:end-block:xrcfr_main.PreCreate
    def __init__(self, parent):
        ...
        # idx = self.GetMenuBar().FindMenu("2x2 view")
        # if idx != wx.NOT_FOUND:
...
def __gettext_strings():
    ...
    _("Save Snapshot as...")
    _("Export as...")
    _("Reset Fine Alignment")
    _("Reset Overview Image")
    _("Stop all Axes")
    _("Recalibrate Sample Holder...")
    _("Quit")
    _("File")
    _("2x2 view")
    _("Play Stream")
    _("Zoom to fit content")
    _("Auto Brightness/Contrast")
    _("Auto Focus")
    _("Show Cross Hair")
    _("Interpolate Content")
    _("View")
    _("User manual")
    _("Development")
    ...
    _("0.00001")
    _("Auto focus")
    _("Attempts to auto focus the spectrometer with all its gratings and detectors.")
    _("Lens")
    _("Step size")
    _("0.000001")
    _("+X")
    ...
    _("→")
    _("Auto focus")
    _("Attempts to auto focus the spectrometer, which is connected via the optical fiber, with all its gratings and detectors.")
    _("Open log panel")
    _("OPTICAL")
    _("Acquire background")
    _("PARK MIRROR")
    _("Cancel")
    _("Open log panel")
    _("OPTICAL")
    ...
    _("ACQUISITION")
    _("Filename")
    _("Select a destination file")
    _("change…")
    _("Destination")
    _("...")
    _("No region of interest selected.")
    _("Cancel")
    _("START")
    _("Select image...")
    _("view")
    ...
    _("STREAMS")
    _("Fine alignment")
    _("Estimated acquisition time is 9999 seconds")
    _("Close")
    _("START")
    _("Image Acquisition")
    _("STREAMS")
