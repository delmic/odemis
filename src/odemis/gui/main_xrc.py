                            ...
                            <object class="wxBoxSizer">
                              ...
                              <object class="sizeritem">
                                <object class="wxBoxSizer">
                                  ...
                                  <object class="sizeritem">
                                    <object class="wxTextCtrl" name="lbl_load_time">
                                      <size>100, -1</size>
                                      <value>Load timer</value>
                                      <fg>#eeeeee</fg>
                                      <bg>#333333</bg>
                                      <hidden>1</hidden>
                                      <style>wxBORDER_NONE|wxTE_NO_VSCROLL|wxTE_READONLY|wxTE_RIGHT|wxTE_DONTWRAP</style>
                                      <XRCED>
                                        <assign_var>1</assign_var>
                                      </XRCED>
                                    </object>
                      ...
                      <object class="wxBoxSizer">
                        ...
                        <object class="sizeritem">
                          <object class="ImageTextToggleButton" name="acq_btn_spectrometer">
                            <label>SPECTROMETER</label>
                            <delta>1</delta>
                            <bitmap>img_button_btn_spec_png</bitmap>
                            <hover>img_button_btn_spec_h_png</hover>
                            <selected>img_button_btn_spec_green_a_png</selected>
                            <fg>#1A1A1A</fg>
                            <font>
                              <size>11</size>
                              <style>normal</style>
                        ...
                        <object class="sizeritem">
                          <object class="ImageTextToggleButton" name="acq_btn_angular">
                            <label>      ANGULAR</label>
                            <delta>1</delta>
                            <bitmap>img_button_btn_ang_png</bitmap>
                            <hover>img_button_btn_ang_h_png</hover>
                            <selected>img_button_btn_ang_green_a_png</selected>
                            <fg>#1A1A1A</fg>
                            <font>
                              <size>11</size>
                              <style>normal</style>
...
\xe9\xa5\xae\x00\x00\x00\x00IEND\xaeB`\x82'''
    ...
    img_button_btn_spec_green_a_png = '''\
\x89PNG\x0d
\x1a
\x00\x00\x00\x0dIHDR\x00\x00\x00\x9c\x00\x00\x000\x08\x06\x00\x00\x00\xe4\
...
\x17\xd5X\xff\xedf\xb1N#\x00\x00\x00\x00IEND\xaeB`\x82'''
    ...
    img_button_btn_ang_green_a_png = '''\
\x89PNG\x0d
\x1a
\x00\x00\x00\x0dIHDR\x00\x00\x00\x9c\x00\x00\x000\x08\x06\x00\x00\x00\xe4\
...
Z\xb9A\x04\xc6\x89\x00\x00\x00\x00IEND\xaeB`\x82'''
    ...
    wx.MemoryFSHandler.AddFile('XRC/main/img_button_btn_spec_png', img_button_btn_spec_png)
    wx.MemoryFSHandler.AddFile('XRC/main/img_button_btn_spec_h_png', img_button_btn_spec_h_png)
    wx.MemoryFSHandler.AddFile('XRC/main/img_button_btn_spec_green_a_png', img_button_btn_spec_green_a_png)
    wx.MemoryFSHandler.AddFile('XRC/main/img_button_btn_ang_png', img_button_btn_ang_png)
    wx.MemoryFSHandler.AddFile('XRC/main/img_button_btn_ang_h_png', img_button_btn_ang_h_png)
    wx.MemoryFSHandler.AddFile('XRC/main/img_button_btn_ang_green_a_png', img_button_btn_ang_green_a_png)
