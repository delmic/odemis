...
class BugreporterFrame(wx.Frame):
    ...
    def __init__(self, controller):
        ...
        name_sizer.Add(name_lbl, 5, wx.EXPAND | wx.ALL, 10)
        name_sizer.Add(name_ctrl, 10, wx.EXPAND | wx.ALL, 5)
        ...
        email_sizer.Add(email_lbl, 5, wx.EXPAND | wx.ALL, 10)
        email_sizer.Add(email_ctrl, 10, wx.EXPAND | wx.ALL, 5)
        ...
        summary_sizer.Add(summary_lbl, 5, wx.EXPAND | wx.ALL, 10)
        summary_sizer.Add(summary_ctrl, 10, wx.EXPAND | wx.ALL, 5)
        ...
        sizer.Add(description_lbl, 0, wx.EXPAND | wx.ALL, 10)
        sizer.Add(description_ctrl, 10, wx.EXPAND | wx.LEFT | wx.RIGHT, 10)
        ...
        attachment_ctrl_sizer.Add(attach_btn, 0, wx.EXPAND | wx.ALL, 10)
        attachment_ctrl_sizer.Add(remove_btn, 0, wx.EXPAND | wx.ALL, 10)
        outer_attachment_sizer.Add(attachment_ctrl_sizer)
        outer_attachment_sizer.AddSpacer(10)
        outer_attachment_sizer.Add(attached_files_lbl, 0, wx.EXPAND | wx.ALL, 10)
        outer_attachment_sizer.AddSpacer(10)
        ...
        gdpr_sizer.Add(gdpr_lbl, 10, wx.EXPAND | wx.ALL, 10)
