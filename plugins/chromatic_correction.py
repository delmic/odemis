...
class ChromaticCorrectionPlugin(Plugin):
    ...
    def __init__(self, microscope, main_app):
        if TabName.CRYOSECOM_LOCALIZATION.value in main_app.main_data.tab.choices.values():
    ...
    def open_dialog_window(self):
        ...
        localization_tab = self.main_app.main_data.getTabByName(TabName.CRYOSECOM_LOCALIZATION.value)
