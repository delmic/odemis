...
if sys.platform.startswith('linux'):
    ...
    scripts = ['install/linux/usr/bin/odemisd',
               ...
               'install/linux/usr/bin/odemis-yaml-selector',
               'util/piconfig',
               'util/pituner',
               'util/piterminal',
               'util/tmcmconfig',
...
dist = setup(name='Odemis',
             ...
             author=u'Éric Piel, Rinze de Laat, Kimon Tsitsikas, Philip Winkler, Anders Muskens, Sabrina Rossberger, Thera Pals, Victoria Mavrikopoulou, Kornee Kleijwegt, Bassim Lazem, Mahmoud Barazi, Arthur Helsloot, Bas Holweg, Canberk Akın, Stefan Sneep, Karishma Kumar, Nandish Patel',
             author_email='piel@delmic.com, laat@delmic.com, tsitsikas@delmic.com, winkler@delmic.com, muskens@delmic.com, rossberger@delmic.com, pals@delmic.com, mavrikopoulou@delmic.com, kleijwegt@delmic.com, lazem@delmic.com, barazi@delmic.com, helsloot@delmic.com, holweg@delmic.com, akin@delmic.com, sneep@delmic.com, kumar@delmic.com, patel@delmic.com',
